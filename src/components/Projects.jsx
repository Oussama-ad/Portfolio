...
const ALL_PROJECTS = [
  ...
  },
  {
    ...
    img: '/assets/Projects/student-info.png',
    alt: 'Student Info Manager',
    desc: 'A cloud-native student management system leveraging Firebase for real-time database updates and authentication. Containerized with Docker for consistent deployment, this application provides an efficient way to track student records, academic performance, and administrative data with a responsive dashboard.',
    tech: ['HTML5', 'CSS3', 'JavaScript', 'Firebase', 'Docker'],
    github: 'https://github.com/',
    live: 'https://info-manger-ef6c6.web.app/',
  },
  {
    title: 'Currency Converter',
    category: 'Applications',
    filterKey: 'applications',
    img: '/assets/Projects/easy-exchange.png',
    alt: 'Currency Converter',
    desc: 'A type-safe currency exchange application built with TypeScript for robust real-time calculations. It integrates with external financial APIs to provide accurate, up-to-the-minute exchange rates for 150+ global currencies, featuring a minimalist interface and optimized performance.',
    tech: ['TypeScript', 'CSS3', 'JavaScript'],
    github: 'https://github.com/',
    live: 'https://easy-exchange-iota.vercel.app/',
  },
]
